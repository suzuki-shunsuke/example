...
func (*HelloRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_hello_12f4a32bfc15b1f4, []int{0}
}
...
func (*HelloReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_hello_12f4a32bfc15b1f4, []int{1}
}
...
type HelloClient interface {
	SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (Hello_SayHelloClient, error)
}
...
func (c *helloClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (Hello_SayHelloClient, error) {
...
type HelloServer interface {
	SayHello(*HelloRequest, Hello_SayHelloServer) error
}
...
func _Hello_SayHello_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(HelloServer).SayHello(m, &helloSayHelloServer{stream})
}
...
func init() { proto.RegisterFile("hello.proto", fileDescriptor_hello_12f4a32bfc15b1f4) }

var fileDescriptor_hello_12f4a32bfc15b1f4 = []byte{
	...
	0x8a, 0x5b, 0x0f, 0x61, 0x94, 0x12, 0x83, 0x01, 0xa3, 0x13, 0x7b, 0x14, 0x2b, 0xd8, 0x3d, 0x49,
	0x6c, 0x60, 0x07, 0x19, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xe7, 0x8c, 0xaa, 0x43, 0x9f, 0x00,
	0x00, 0x00,
}
